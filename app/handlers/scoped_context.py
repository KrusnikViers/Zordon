...
class ScopedContext(ScopedSession):
    ...
    def __enter__(self):
        super(ScopedContext, self).__enter__()
        self._translation.install()
        return self

    def __exit__(self, exc_type, exc_val, exc_tb):
        super(ScopedContext, self).__exit__(exc_type, exc_val, exc_tb)
